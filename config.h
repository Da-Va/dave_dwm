...
static const char *fonts[]          = { "mononoki NF:size=10" };
// static const char dmenufont[]       = "monospace:size=10"; 
// static const char dmenufont[]       = "Code New Roman Nerd Font:size=10";
static const char dmenufont[]       = "mononoki NF:size=10";
/* Colors */
...
static const char col_orange[]        = "#c50f1f";
...
static const char *filecmd[] = { "tabbed", "-c", "-r", "2", "st", "-w", "", "-e", "nnn", NULL };
/* sound */
static const char *mutetogglecmd[] = {"pactl", "set-sink-mute", "@DEFAULT_SINK@", "toggle", NULL};
static const char *volraisecmd[] = {"pactl", "set-sink-volume", "@DEFAULT_SINK@", "+2%", NULL};
static const char *vollowercmd[] = {"pactl", "set-sink-volume", "@DEFAULT_SINK@", "-2%", NULL};
// static const char *mutetogglecmd[] = {"amixer", "set", "Master", "toggle", NULL};
// static const char *volraisecmd[] = {"amixer", "set", "Master", "2%+", NULL};
// static const char *vollowercmd[] = {"amixer", "set", "Master", "2%-", NULL};
/* keyboard layout */
static const char *keylayoutcmd[] = {"cycle_keyboard_layout"};
